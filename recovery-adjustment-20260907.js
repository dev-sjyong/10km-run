(() => {
  // 피부 회복 기간 + 2026-09-08 복귀 러닝을 반영한 최신 계획
  // 복귀 러닝: 4.64km / 30:30 / 6:34/km / 평균 HR 161 / 후반 HR 173 / 상승 42m
  // 러닝 감각은 유지됐지만 Easy보다 강도가 높았으므로 9/9은 회복,
  // 이후 거리 적응을 먼저 복구하고 강도는 단계적으로 재도입한다.
  const adjustments = {
    "2026-09-04": {
      type: "rest",
      title: "훈련 미실시 · 보충 안 함",
